...
window.TinyPPI = (function () {
  ...
  const T = {
    ...
    series_search: "Search series", series_back: "All series",
    series_unseen: "Unwatched episodes", series_season: "Season %s",
    series_specials: "Specials",
    series_failed: "Episodes could not be loaded",
